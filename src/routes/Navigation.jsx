  ...
  return (
    <Router>
        ...
        <Nav className="mr-auto">
          <Link style={{ textDecoration: 'none' , marginRight: 10 , color: 'grey'}} to="/AnalistaABM">Analista ABM</Link>
          <Link style={{ textDecoration: 'none' , marginRight: 10 , color: 'grey'}} to="/AnalistaComercial">Analista Comercial</Link>
          <Link style={{ textDecoration: 'none' , color: 'grey'}} to="/Administrador">Administrador</Link>
        </Nav>
